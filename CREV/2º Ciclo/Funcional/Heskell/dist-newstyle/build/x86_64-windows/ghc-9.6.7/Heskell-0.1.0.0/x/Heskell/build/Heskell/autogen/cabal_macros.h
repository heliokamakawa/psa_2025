...
/* package Heskell-0.1.0.0 */
#ifndef VERSION_Heskell
#define VERSION_Heskell "0.1.0.0"
#endif /* VERSION_Heskell */
#ifndef MIN_VERSION_Heskell
#define MIN_VERSION_Heskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Heskell */
...
#define CURRENT_COMPONENT_ID "Heskell-0.1.0.0-inplace-Heskell"
